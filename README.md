...
This project provides the City Council Data, Headshots & City Photo for Philadelphia, PA ( JSON, XML, CSV, SQL & YML formats ).  See [Provided Data](#provided-data) below for full list of data in this project.


Completed Tasks
---

We have completed the following Data Collection for Philadelphia, PA. [Watch Project](https://github.com/CivilServiceUSA/city-council-pa-philadelphia/subscription) to be notified of updates.
...
You will want to use [Philadelphia's Official City Council Website](http://phlcouncil.com/) to populate this data. However, they may not have 100% of what we collect, so Google is your friend there :)

### [☑ Manage City Council Data](https://docs.google.com/spreadsheets/d/1_2ZBcbSjvEdRTZCNn-a41kaYmXLnxcadRGEWpoLwNME/edit#gid=0)
